...
public class JsonSpreadsheetParserTest extends AbstractBuilderTest {

    @Override
    protected void build(SpreadsheetBuilder builder, String sheet) throws Exception {
        new JsonSpreadsheetParser(builder).parse(JsonSpreadsheetParserTest.class.getResourceAsStream(sheet + ".json"));
    }
}
